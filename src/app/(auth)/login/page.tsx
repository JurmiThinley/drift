      ...
      <Card className="w-full max-w-md relative z-10 glass border-white/10">
        <CardHeader className="text-center">
          <Link href="/" className="inline-block mb-4">
            <span className="font-display text-3xl font-light text-drift-400">drift</span>
          </Link>
          <CardTitle className="text-2xl font-display font-light">Welcome back</CardTitle>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center">
              ...
              <Link href="/register" className="text-drift-400 hover:underline">
                Sign up
              </Link>
            </p>
          </CardFooter>
